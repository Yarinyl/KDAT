...
from ObjectDetection.ModFaster.gen_rcnn import GeneralizedRCNN
from ObjectDetection.ModFaster.roi import RoIHeads
from ObjectDetection.ModFaster.rpn import RegionProposalNetwork, RPNHead
...
def fasterrcnn_resnet50_fpn_cust(
    *,
